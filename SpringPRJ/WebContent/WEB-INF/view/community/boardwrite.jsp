...
<body>
<img src="/resource/img/logo.png" width="200px" height="75px" alt="올포유 로고" />
    <br>
    <br>
	...
	<article>
		...
		<div class="container" role="main">
			...
			<form name="form" id="form" role="form" method="post" action="${pageContext.request.contextPath}community/boardlist.do">
