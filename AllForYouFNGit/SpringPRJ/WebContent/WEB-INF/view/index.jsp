						...
						<div
							...
							<div class="hexagon-menu clear clear_div">
								...
								<div class="hexagon-item ">
									...
									<a href="ocr/imageFileUpload.do" class="hex-content"> <span
										class="hex-content-inner"> <span class="icon"> <i
												class=""><img src="/resource/img/allergy_icon.png"
													class="img_icon"></i>
										</span> <span class="title">알레르기 검색</span>
								...
								<div class="hexagon-item ">
									...
									<a href="/FoodForum.do" class="hex-content"> <span
										class="hex-content-inner"> <span class="icon"> <i
												class=""><img src="/resource/img/food_icon.png"
													class="img_icon"></i>
										</span> <span class="title">음식<br>게시판
										</span>
									</span> <svg viewbox="0 0 173.20508075688772 200" height="200"
											width="174" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            <path
								...
								<div class="hexagon-item div_hid">
									...
									<a href="/community/boardlist.do" class="hex-content"> <span
										class="hex-content-inner"> <span class="icon"> <i
												class=""><img src="/resource/img/people_icon.png"
													class="img_icon"></i>
										</span> <span class="title">커뮤니티 게시판</span>
									</span> <svg viewbox="0 0 173.20508075688772 200" height="200"
											width="174" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            <path
												d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z"
								...
								<div class="hexagon-item">
									...
									<a href="/mypage.do" class="hex-content"> <span
										class="hex-content-inner"> <span class="icon"> <i
												class=""><img src="/resource/img/person_icon.png"
													class="img_icon"></i>
								...
								<div class="hexagon-item">
									...
									<a href="/customerCenter/csCenterMail.do" class="hex-content">
										<span class="hex-content-inner"> <span class="icon">
												<i class=""><img src="/resource/img/service_icon.png"
													class="img_icon"></i>
										</span> <span class="title">고객센터</span>
									</span> <svg viewbox="0 0 173.20508075688772 200" height="200"
											width="174" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            <path
												d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z"
