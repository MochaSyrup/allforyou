									...
									<div class="col-xs-12 col-sm-6 email_length">
										<div class="input-field email">
											<span class="input-icon" id="email"><i
												...
												placeholder="아이디 : <%=pDTO.getUser_id()%>" disabled/>
										</div>
									</div>
									<!-- ./col- -->
									...
									<div class="col-xs-12 col-sm-12">
										<div class="input-field message">
											<div class="check_styl">
			                                    <p>나의 알레르기 (복수선택)</p>
			                                    <input type="checkbox" id="갑각류" name="allergy1" value="갑각류" <%=hm.get("갑각류")%>> 갑각류
			                                    <input type="checkbox" id="달걀" name="allergy2" value="달걀" <%=hm.get("달걀")%>> 달걀
			                                    <input type="checkbox" id="땅콩" name="allergy3" value="땅콩"<%=hm.get("땅콩")%>> 땅콩
			                                    <input type="checkbox" id="밀" name="allergy4" value="밀" <%=hm.get("밀")%>> 밀
			                                    <input type="checkbox" id="생선" name="allergy5" value="생선" <%=hm.get("생선")%>> 생선
			                                    <input type="checkbox" id="우유" name="allergy6" value="우유" <%=hm.get("우유")%>> 우유
			                                    <input type="checkbox" id="조개" name="allergy7" value="조개" <%=hm.get("조개")%>> 조개
			                                    <input type="checkbox" id="콩" name="allergy8" value="콩" <%=hm.get("콩")%>> 콩
			                                 </div>
										</div>
									</div>
